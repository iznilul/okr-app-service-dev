...
public class AdminController {
    ...
    @GetMapping("fetch")
    @ResponseBody
    public ResultKit<Object> fetchAllStudents(@RequestParam("secretKey") String secretKey,
        ...
        List<SignUp> signUps = adminService.fetchAllStudents();
        if (signUps != null) {
            resultKit.setCode(200);
            resultKit.setData(signUps);
